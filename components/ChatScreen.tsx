...
export function ChatScreen() {
  ...
  const handleVncUrl = useCallback((_info: VncInfo) => {
    // VNC session info received from agent — currently no VNC panel in ChatScreen
    // but we accept the callback to keep the hook wired for future integration
  }, []);
  const { messages, isLoading, isWaitingForUser, error, sendMessage, stop, clear } = useChat(handleVncUrl);
