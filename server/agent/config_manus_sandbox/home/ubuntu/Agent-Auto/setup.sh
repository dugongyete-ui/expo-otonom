...
echo -e "${CYAN}${BOLD}║        LLM: Cerebras AI (qwen-3-235b-a22b)                    ║${NC}"
echo -e "${CYAN}${BOLD}╚═══════════════════════════════════════════════════════════════╝${NC}"
echo ""
...
check_env "CEREBRAS_API_KEY"  "Cerebras AI API Key (WAJIB untuk AI)"
...
# Cerebras AI (WAJIB untuk fitur AI)
# Dapatkan API key dari: https://cloud.cerebras.ai/
CEREBRAS_API_KEY=
